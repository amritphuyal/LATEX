...
\renewcommand{\lstlistlistingname}{List of Outputs}
...
\lstdefinestyle{customa}{
    ...
    basicstyle=\ttfamily\footnotesize\color{bluefront},
...
\newcommand {\CMD}[2]{
    ...
    \begin{mdframed}[backgroundcolor=blueback,innerbottommargin=-2em,innertopmargin=-0.1em]
